			...
			d=d.toTimeString().split(' ')[0];
					if(music_notes.length>45)
						{	var tmp_notes=music_notes;
							...
							console.log('before verification',unique_notes[0],unique_notes[1],'flag',flag,'swaraIndex',swaraIndex,'swarasCount',swarasCount,'left_leaf_node',left_node_mistake,'right_node_mistake',right_node_mistake,'repetation',tmp_repeatation);
